...
// 登录状态信息
let login_name = getCookie("login_name"); // 登录名
let login_token = getCookie("login_token"); // 用户token
let login_id = getCookie("login_id"); // 用户id
let login_level = -1; // 管理员等级
let login_nickname = ""; // 昵称
